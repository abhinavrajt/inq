      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-between text-white px-6 md:px-16 py-10 md:py-16 z-10">
        ...
        <div className="flex justify-between text-3xl md:text-4xl">
          <div className="text-left">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="font-extrabold font-pixel">32K+</p>
            </div>
          ...
          <div className="text-right">
            <div className="flex items-center gap-3 justify-end mb-2">
              <p className="font-extrabold font-pixel">18K+</p>
        ...
        <div className="flex justify-center items-center">
          <div className="max-w-5xl w-full text-center px-4">
            <img
              src="/images/inqualogo.png"
              alt="INQUA Logo"
              className="mx-auto w-72 md:w-96 drop-shadow-[0_0_55px_rgba(0,0,0,0.9)]"
            />
        ...
        <div className="flex justify-between text-3xl md:text-4xl">
          <div className="text-left">
            <div className="flex items-center gap-3 mb-2">
              ...
              <p className="font-extrabold font-pixel">75+</p>
            </div>
          ...
          <div className="text-right">
            <div className="flex items-center gap-3 justify-end mb-2">
              <p className="font-extrabold font-pixel">180+</p>
